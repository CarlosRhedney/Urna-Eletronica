...
public class PaginaUrnaEletronica2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PaginaUrnaEletronica2 frame = new PaginaUrnaEletronica2();
	...
	public PaginaUrnaEletronica2() {
		...
		label.setIcon(new ImageIcon(PaginaUrnaEletronica2.class.getResource("/programUrnaImg/user.png")));
		...
		txtNomeCandidato.setToolTipText("Nome Senador");
		txtNomeCandidato.setEditable(false);
		txtNomeCandidato.setBounds(62, 213, 210, 20);
		...
		txtNumeroCandidato.setToolTipText("Numero Senador");
		txtNumeroCandidato.setEditable(false);
		txtNumeroCandidato.setBounds(82, 246, 55, 20);
		...
		button3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// Se nao for é redirecionado para a pagina de candidatos
				String NumCand = txtNumeroCandidato.getText();
				if(NumCand.equals("63")) {
					txtNomeCandidato.setText("Nilo Peçanha");
				}else if(NumCand.equals("84")) {
					txtNomeCandidato.setText("Hermes da Fonseca");
				}else if(NumCand != "63" || NumCand != "84") {
					JOptionPane.showMessageDialog(null, "Candidato Inválido, abrindo tela de candidatos!", "Erro", JOptionPane.ERROR_MESSAGE);
					PaginaCandidatos2 frame = new PaginaCandidatos2();
					frame.setVisible(true);
				}
		...
		// Botão Branco chamando o metodo que insere o voto em branco no banco de dados.
		...
		JLabel lblUrnaEletrnica = new JLabel("Senador");
	...
	public void ConfirmaVoto() {
		...
		if(votos.equals("63")) {
			stmt.executeUpdate("insert into votosdir2 (votos) values ('" + votos + "')");
			JOptionPane.showMessageDialog(null, "Voto cadastrado com sucesso!", "Info", JOptionPane.INFORMATION_MESSAGE);
		}else if(votos.equals("84")) {
			stmt.executeUpdate("insert into votosesq2 (votos) values ('" + votos + "')");
			JOptionPane.showMessageDialog(null, "Voto cadastrado com sucesso!", "Info", JOptionPane.INFORMATION_MESSAGE);
		}
	...
	public void VotoBranco() {
		...
		String votos = "0";
			stmt.executeUpdate("insert into votosbrancos2 (votos) values ('" + votos + "')");
			JOptionPane.showMessageDialog(null, "Voto cadastrado com sucesso!", "Info", JOptionPane.INFORMATION_MESSAGE);
			dispose();
